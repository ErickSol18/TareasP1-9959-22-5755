...
void imprimirMatriz1(float matriz1[NUMERO_PARTICIPANTES1][NUMERO_PROCESOS + 1], char partidos[NUMERO_PARTICIPANTES1][MAX_DISTANCIA_CADENA]); //cambio
void imprimirMatriz2(float matriz2[NUMERO_PARTICIPANTES2][NUMERO_PROCESOS + 1], char partidos[NUMERO_PARTICIPANTES2][MAX_DISTANCIA_CADENA]);//cambio
void imprimirMatriz3(float matriz3[NUMERO_PARTICIPANTES3][NUMERO_PROCESOS + 1], char partidos[NUMERO_PARTICIPANTES3][MAX_DISTANCIA_CADENA]);//cambio
int main()
{
    srand(getpid());
...
void llenarMatriz1(float matriz1[NUMERO_PARTICIPANTES1][NUMERO_PROCESOS + 1])
{
    ...
    for (y = 0; y < NUMERO_PARTICIPANTES1; y++)
    {
        ...
        {
            int calificacion = busquedaAleatorios(MIN_PUNTAJE, MAX_CALIFICACION_2017);

            matriz1[y][0] = calificacion;
            int calificacion2 = busquedaAleatorios(MIN_PUNTAJE, MAX_CALIFICACION_2019);

            matriz1[y][1] = calificacion2;
            int calificacion3 = busquedaAleatorios(MIN_PUNTAJE, MAX_CALIFICACION_2021);
