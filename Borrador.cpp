// Laboratorio de notas de la universidad
# incluir  < stdio.h >
# incluir  < stdlib.h >
# include  < unistd.h >
# incluir  < cadena.h >
...
int  principal ()
{
    ...
    char alumnos1[NUMERO_ALUMNOS1][MAXIMA_LONGITUD_CADENA] = { " Luisa " , " Barry " , " María " , " Pedro " , " Juana " , " Chris " , " Mario " , " Celia " , " Bryan " , " Kevin " } ;
